                ...
                <div className="flex flex-col lg:flex-row gap-16 lg:gap-12 items-center">
                    ...
                    >
                        ...
                        <h2 className="font-brand text-3xl md:text-4xl lg:text-5xl font-[900] text-text-main leading-[1.05] tracking-tight mb-4">
                            ...
                            infrastructure of Southeast Asia.
                        </h2>

                        <div className="space-y-4 font-brand text-[15px] leading-relaxed text-text-sub max-w-xl">
                            <p>
                                The Invest Smart Community (ISC) Project is a
                                landmark renewable energy initiative developed
                                by Ample Rich Investors Corp. and BS Industry
                                Service Co., Ltd. under Thailand&apos;s
                                Renewable Energy Power Plant Industry
                                Development Master Plan.
                            </p>
                            <p>
                                The project integrates{" "}
                                <b className="font-bold">
                                    solar power generation, grid modernisation,
                                    and blockchain FinTech{" "}
                                </b>
                                to create a resilient, transparent, and
                                community-owned energy ecosystem — with the
                                long-term goal of becoming the electricity
                                distribution hub of ASEAN.
                            </p>
                            <p>
                                Phase 1 is underway in Phichit City — a pilot
                                covering 1,557 acres of solar infrastructure to
                                demonstrate the model before national and
                                regional expansion.
                            </p>
                        </div>
                        ...
                        <div className="flex flex-wrap gap-4 mt-6 mb-6">
                            ...
                            <Button
                                variant="outline"
                                className="border-border/50 text-text-sub font-brand text-xs font-bold h-12 px-8 rounded-lg hover:text-button-primary-text hover:border-border transition-all"
                            >
                                Contact the team
                            </Button>
                        </div>
                        ...
                        <div className="relative aspect-[16/10] bg-panel-dark rounded-[32px] overflow-hidden border border-border/5 shadow-2xl group cursor-crosshair">
                            ...
                            <div className="absolute bottom-[30%] left-12 right-12 space-y-2">
                                {[...Array(3)].map((_, rowIndex) => (
                                    <div
                                        key={rowIndex}
                                        className="grid grid-cols-6 gap-x-1.5 gap-y-1"
                                    >
                            ...
                            <div className="absolute bottom-10 left-12">
                                ...
                                <p className="font-brand text-[11px] font-medium text-panel-dark-text/40 tracking-tight">
                                    Phichit City, Thailand · Phase 1 · 1,557
                                    acres
                                </p>
                            </div>
                        </div>
